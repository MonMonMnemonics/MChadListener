...
#include "ui_windowcontrol.h"
#include "sharedvar.h"
#include <QJsonDocument>
#include <QInputDialog>

WindowControl::WindowControl(QWidget *parent, StreamViewer *SV) :
    QDialog(parent),
    ui(new Ui::WindowControl)
{
...
//--------------------------------------------- Room Page --------------------------------------------
void WindowControl::RMClosebtn(){
    this->close();
}

void WindowControl::RMEnterbtn() {
    bool ok = false;
...
void WindowControl::RMgetroom() {
    request.setUrl(QUrl("http://157.230.241.238/Room/"));
    manager->get(request);
}

void WindowControl::ClickLinkText(const QString &link){
...
void WindowControl::RMReqParser(QString reqresult){
